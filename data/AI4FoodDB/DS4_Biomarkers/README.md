...
The directory [`glucose_levels`](https://github.com/AI4Food/AI4FoodDB/tree/master/datasets/DS4_Biomarkers/Glucose%20Levels) contains continuous glucose monitoring (CGM) data from each participant. Files are named `A4F_XXXXX_glucose_levels.csv` and record glucose values collected approximately every 15 minutes over the 14-day digital data collection period.
